...
export const workshops = [
    {
        id: 1,
        title: "Rocscience Software Workshop",
        description:
            "A hands-on technical workshop introducing participants to industry-standard Rocscience software for geotechnical analysis and design. The session focuses on practical applications such as slope stability, rock and soil modeling, and excavation analysis, helping participants translate theoretical concepts into real-world engineering solutions.",
        image: "/images/ProfessorSeminar.webp",
    },
    {
        id: 2,
        title: "BIS Seminar",
